...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { course_id: @instructor.course_id, name: @instructor.name } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { course_id: @instructor.course_id, name: @instructor.name } }
